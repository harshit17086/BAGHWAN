...
export default function EditServicePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    setUploadProgress('Updating service...');
    ...
    try {
      ...
      if (image) {
        ...
        const imageUrl = await uploadImage(image, serviceId);
      ...
      setUploadProgress('Service updated successfully!');
      router.push('/admin/services');
    } catch (error) {
      console.error('Error updating service:', error);
      setUploadProgress('Error updating service. Please try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-serif font-bold text-[#2F3D24]">Edit Service</h1>
